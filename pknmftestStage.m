function [l,score] = pknmftestStage(A,B,C,W3,X3,d3,training_number,c,pn)
...
%                  'C'       - Class labeles
%      
%                  'W3'      - the new basis matrix calculated by pknmf algorithm 
%   
%                  'X3'      - Data matrix
%
%                  'd3'      - polynomial Kernel function parameter
%                              function parameter
%
...
[K_WW4] = kernelFunction1(W3,W3,d3);
...
for j=1:c
    [K_WX4] = kernelFunction1(W3,X3(:,B(:,j)),d3);
...
for i = 1:k
    K_Wy = kernelFunction1(W3,X3(:,A(i)),d3);
